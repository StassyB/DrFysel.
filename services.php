        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="700">
            <div class="service-item">
              <div class="img">
                <img src="assets/img/3.jfif" class="" alt="" height="320px">
              </div>
              <div class="details position-relative">
                <div class="icon">
                  <i class="bi bi-chat-square-text"></i>
                </div>
                <a href="department/ophtalmology.php" class="stretched-link">
                  <h3>General Dermatology</h3><br><br>
                </a>
                <p>
                  Diagnosis and treatment of common skin conditions</p><br><br>
                 
                <a href="service.php" class="stretched-link"></a>
              </div>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="600">
            <div class="service-item">
              <div class="img">
                <img src="assets/img/1.jfif" class="" alt="" height="320px" >
              </div>
              <div class="details position-relative">
                <div class="icon">
                  <i class="bi bi-person-wheelchair"></i>
                </div>
                <a href="department/plastic_and_construction_surgery.php" class="stretched-link">
                  <h3>Dermatologic Surgery</h3>
                </a><br><br>
                <p>Expert surgical procedures for various skin issues.</p><br><br>
               
              
                <a href="department/index.php" class="stretched-link"></a>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="700">
            <div class="service-item">
              <div class="img">
                <img src="assets/img/2.jfif" class="" alt="" height="320px">
              </div>
              <div class="details position-relative">
                <div class="icon">
                  <i class="bi bi-chat-square-text"></i>
                ...
                <p>Enhancing your natural beauty with cutting-edge cosmetic treatments.</p><br><br>
