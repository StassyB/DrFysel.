    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="doc.php" class="active">Doctors</a></li>
  ...
  .tick-list {
    ...
    <section id="team" class="team section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Our Doctors</h2><hr>
        <p>Our staff of dermatologists offers expert guidance and comprehensive treatment for a wide range of skin, hair, and nail health issues. From dandruff and dermatitis to photoaging, rashes, rosacea, skin tags, skin cancer, and warts, our team is dedicated to providing exceptional care and personalized treatment options.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="assets/img/photo_2023-11-28_16-37-52.jpg" class="img-fluid" alt="">
              </div>
              <div class="member-info">
                ...
                <span>12 Years Experience </span>
                 <span>Tikur Anbessa/ ALERT Hospital / Dr Feysel Dermatology Clinic </span>
              </div>
            </div>
          </div><!-- End Team Member -->
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="400">
            <div class="team-member">
              <div class="member-img">
                <img src="assets/img/photo_2023-11-28_16-37-48-240x300.jpg" class="" alt="" height="450px">
